...
export default function Bio() {
  ...
  const [hoveredArts, setHoveredArts] = useState(false);
          ...
          <div className="flex flex-col items-center gap-10">
            ...
            <div className="w-full flex justify-center">
              <div className="w-[80%]">
                ...
                >
                  <p className={`text-xl leading-relaxed text-black text-center ${isXs ? 'px-2' : 'px-8'}`}>
                    A <span style={{ color: '#1E407C' }}>Penn State</span> student researching{' '}
                    ...
                    >
                      HTI Lab
                    </a>. Solving real problems for real people. Hobbies include{' '}
                    <span 
                    ...
                    <span 
                      className="relative cursor-pointer"
                      style={{ color: '#F8C46F' }}
                      onMouseEnter={() => setHoveredArts(true)}
                      onMouseLeave={() => setHoveredArts(false)}
                    >
                      the arts
                      {hoveredArts && (
                        <span className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-black text-white text-sm px-2 py-1 rounded whitespace-nowrap z-50 pointer-events-none block">
                          graphic design is my passion :v
                        </span>
                      )}
                    </span>.
                  </p>
        ...
        <div className="flex items-center h-full gap-0">
          ...
          <div className="w-2/5 flex flex-col items-center justify-center text-center">
            ...
            >
              ...
              <span 
                className="text-[12rem] xl:text-[14rem] font-bold tracking-tight leading-none"
                style={{ 
                  color: '#F8C46F',
                  marginLeft: '0.1em'
                }}
          ...
          <div className="w-3/5 pl-12 h-full flex items-center justify-center">
            <div className="w-[80%]">
              ...
              >
                <p className="text-3xl leading-relaxed text-black text-center">
                  A <span style={{ color: '#1E407C' }}>Penn State</span> student researching{' '}
                  <span style={{ color: '#FF6B6B' }}>Computer Assisted Driving</span> at{' '}
                  <a 
                    href="https://www.ime.psu.edu/research/facilities-and-labs/human-technology-interaction-lab.aspx" 
